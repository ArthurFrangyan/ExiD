...
namespace Tests.EditMode
{
    ...
    public class BlockTests
    {
        ...
        {
            _blockEmpty.SetWall(Vector3Int.right, true);
            _blockEverything.SetWall(Vector3Int.right, false);
        ...
        {
            _blockEmpty.SetWall(Vector3Int.left, true);
            _blockEverything.SetWall(Vector3Int.left, false);
        ...
        {
            _blockEmpty.SetWall(Vector3Int.forward, true);
            _blockEverything.SetWall(Vector3Int.forward, false);
        ...
        {
            _blockEmpty.SetWall(Vector3Int.back, true);
            _blockEverything.SetWall(Vector3Int.back, false);
        ...
        {
            Assert.Throws<System.ArgumentException>(() => _blockEmpty.SetWall(new Vector3Int(1,0,1), true));
        }
    }
}